...
(function () {
  ...
  var I18N = {
    pt: {
      ...
      "hero.lead": "<em>Do teatro à dança —<br>de São Paulo a Moscou.</em>",
      "hero.cta": "Ver trabalhos", "hero.index": "Retrato", "hero.scroll": "rolar",
      "sobre.title": "Sobre",
      "sobre.lead": "Larissa da Matta é atriz, dançarina, performer e pesquisadora.",
      "sobre.p1": "É bacharel e licenciada em Teatro pela Escola Superior de Artes Célia Helena. Trabalha entre teatro, audiovisual, dança e moda, no Brasil e em festivais na América Latina e na Rússia.",
      ...
      "sobre.form.4": "Pós-graduação — Direção e Atuação · pesquisa Dramaturgias do Corpo",
      ...
      "aulas.c3.t": "Pilates", "aulas.c3.d": "Aulas de Pilates, individuais ou em grupo.",
      "aulas.c4.t": "Curso livre de Teatro", "aulas.c4.d": "Curso livre de teatro para iniciantes e atores em formação.",
    ...
    en: {
      ...
      "hero.lead": "<em>From theatre to dance —<br>from São Paulo to Moscow.</em>",
      "hero.cta": "View work", "hero.index": "Portrait", "hero.scroll": "scroll",
      "sobre.title": "About",
      "sobre.lead": "Larissa da Matta is an actress, dancer, performer and researcher.",
      "sobre.p1": "She holds a bachelor's and teaching degree in Theatre from Escola Superior de Artes Célia Helena. She works across theatre, film, dance and fashion, in Brazil and at festivals in Latin America and Russia.",
      ...
      "sobre.form.4": "Postgraduate — Directing and Acting · research Dramaturgias do Corpo",
      ...
      "aulas.c3.t": "Pilates", "aulas.c3.d": "Pilates classes, one-on-one or in a group.",
      "aulas.c4.t": "Theatre — Open Course", "aulas.c4.d": "Open theatre course for beginners and actors in training.",
    ...
    es: {
      ...
      "hero.lead": "<em>Del teatro a la danza —<br>de São Paulo a Moscú.</em>",
      "hero.cta": "Ver trabajos", "hero.index": "Retrato", "hero.scroll": "desplázate",
      "sobre.title": "Sobre",
      "sobre.lead": "Larissa da Matta es actriz, bailarina, performer e investigadora.",
      "sobre.p1": "Es licenciada en Teatro por la Escola Superior de Artes Célia Helena. Trabaja entre teatro, audiovisual, danza y moda, en Brasil y en festivales de América Latina y Rusia.",
      ...
      "sobre.form.4": "Posgrado — Dirección y Actuación · investigación Dramaturgias do Corpo",
      ...
      "aulas.c3.t": "Pilates", "aulas.c3.d": "Clases de Pilates, individuales o en grupo.",
      "aulas.c4.t": "Curso libre de Teatro", "aulas.c4.d": "Curso libre de teatro para principiantes y actores en formación.",
